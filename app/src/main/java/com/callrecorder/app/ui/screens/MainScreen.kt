...
private val NavBarBg      = Color(0xFF5F6071)
...
enum class BottomTab(val label: String, val pathData: String) {
    ...
    CUSTOMERS("고객", IconPaths.PERSON),
    CALENDAR("캘린더", IconPaths.CALENDAR),
...
private object IconPaths {
    ...
    const val PERSON =
        "M13.9531 18.5778V15.0778C13.9531 14.2821 13.6371 13.519 13.0744 12.9564C12.5118 12.3938 11.7488 12.0777 10.9531 12.0777H4.95312C4.15748 12.0777 3.39441 12.3938 2.8318 12.9564C2.2692 13.519 1.95312 14.2821 1.95312 15.0778V18.5778 " +
                "M18.4531 18.5778V15.0778C18.4526 14.4131 18.2314 13.7673 17.8241 13.242C17.4169 12.7166 16.8467 12.3414 16.2031 12.1752 " +
                "M13.2031 3.17514C13.8484 3.34036 14.4204 3.71567 14.8289 4.24188C15.2373 4.76809 15.459 5.41529 15.459 6.08142C15.459 6.74755 15.2373 7.39474 14.8289 7.92095C14.4204 8.44716 13.8484 8.82247 13.2031 8.9877 " +
                "M10.9531 6.07767C10.9531 7.73453 9.60998 9.0777 7.95312 9.0777C6.29627 9.0777 4.95312 7.73453 4.95312 6.07767C4.95312 4.42081 6.29627 3.07764 7.95312 3.07764C9.60998 3.07764 10.9531 4.42081 10.9531 6.07767Z"
    const val CALENDAR =
        "M6.66406 1.6665V4.99984 " +
                "M13.3359 1.6665V4.99984 " +
                "M15.8333 3.3335H4.16667C3.24619 3.3335 2.5 4.07969 2.5 5.00016V16.6668C2.5 17.5873 3.24619 18.3335 4.16667 18.3335H15.8333C16.7538 18.3335 17.5 17.5873 17.5 16.6668V5.00016C17.5 4.07969 16.7538 3.3335 15.8333 3.3335Z " +
                "M2.5 8.3335H17.5"
    const val SETTING =
...
private fun BottomTabBar(
    ...
    // 이미지: 배경 #5F6071, 높이 60. 선택 탭은 Rectangle_4 흰 곡선(72×32) 위에 검정 아이콘 + 아래 흰 라벨.
    Row(
        modifier = modifier
            .fillMaxWidth()
            .height(60.dp)
            ...
            Box(
                ...
                if (isSelected) {
                    ...
                    Column(
                        ...
                        // 곡선 위 검정 아이콘
                        StrokeIcon(pathData = tab.pathData, color = Color(0xFF1E1E1E), modifier = Modifier.size(20.dp).offset(y = 6.dp))
                        Spacer(Modifier.height(10.dp))
                        Text(
                            tab.label,
                            style = TextStyle(fontSize = 11.sp, fontWeight = FontWeight.Normal, color = Color.White),
                        )
                    }
                } else {
